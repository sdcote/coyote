 ...
 *
 * <p>This parser only supports extracting a string value from a DN. It does
 * not support values in the hex-string style.
 */
final class DistinguishedNameParser {
   ...
   * 
   * <p>The char pair is composed of DN char in specified 'position' and the 
   * next char. According to BNF syntax:<pre>
   * hexchar    = DIGIT / "A" / "B" / "C" / "D" / "E" / "F"
   *                    / "a" / "b" / "c" / "d" / "e" / "f"
   * </blockquote>
   *  
   * @param position index to the character
   * 
   ...
   * Decodes UTF-8 char.
   * 
   * <p>see http://www.unicode.org for UTF-8 bit distribution table.
   * 
  ...
  /**
   * @return gets next attribute type: (ALPHA 1*keychar) / oid
   */
  ...
  /**
   * @return quoted attribute value: QUOTATION *( quotechar / pair ) QUOTATION
   */
