...
import coyote.batch.web.Method;
import coyote.batch.web.Parameters;
import coyote.batch.web.Resource;
import coyote.batch.web.decorator.RequestDecorator;
...
public abstract class AbstractWorker implements ResourceWorker {
  ...
  protected class RequestRunner implements Runnable {
    HttpRequest request;
    coyote.batch.web.Response response;
    Parameters parameters;




    protected RequestRunner( final HttpRequest request, final coyote.batch.web.Response response, final Parameters params ) {
  ...
  /**
   * @see coyote.batch.web.worker.ResourceWorker#marshalRequestBody(org.apache.http.client.methods.HttpEntityEnclosingRequestBase, coyote.batch.web.Parameters)
   */
  @Override
  ...
  /**
   * @see coyote.batch.web.worker.ResourceWorker#marshalResponseBody(coyote.batch.web.Response, org.apache.http.HttpResponse, coyote.batch.web.Parameters)
   */
  @Override
  public void marshalResponseBody( final coyote.batch.web.Response workerResponse, final HttpResponse httpResponse, final Parameters params ) {
    try {
   ...
   *
   * @see coyote.batch.web.worker.ResourceWorker#request(coyote.batch.web.Parameters)
   */
  @Override
  public coyote.batch.web.Response request( final Parameters params ) throws InvocationException {

    final coyote.batch.web.Response retval = new coyote.batch.web.Response();
   ...
   *
   * @see coyote.batch.web.worker.ResourceWorker#send(coyote.batch.web.Parameters)
   */
  @Override
