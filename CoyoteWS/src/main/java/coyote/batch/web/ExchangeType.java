...
import coyote.batch.web.worker.BasicWorker;
import coyote.batch.web.worker.HtmlWorker;
import coyote.batch.web.worker.JsonRestWorker;
import coyote.batch.web.worker.ResourceWorker;
import coyote.batch.web.worker.SoapWorker;
import coyote.batch.web.worker.XmlRestWorker;
