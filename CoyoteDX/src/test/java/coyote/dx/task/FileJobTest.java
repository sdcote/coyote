...
public class FileJobTest {
  ...
  public static void tearDownAfterClass() throws Exception {
    ...
    FileUtil.deleteDirectory(new File("FileJobTest"));
  }
  ...
  public void base() throws ConfigurationException, TaskException, IOException {
    ...
    cfg.put(ConfigTag.DIRECTORY, "src/resources/licenses");
    cfg.put(ConfigTag.NAME, "FileJobTest"); // override the name of the job
    Log.info("\"FileJob\":" + cfg);

    try (FileJob task = new FileJob()) {
      ...
      final Object results = context.get("FileJobTest");
      ...
      final Map jobContext = context.getAsMap("FileJobTest");
      ...
      // There is only one license in that directory
