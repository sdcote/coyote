...
/**
 * Creates simple formatted tables from text characters for use in text reports and console applications.
 */
public class TextTable {
   ...
   */
  private AbstractTableFormat tableFormat = new UTF8TableFormat();

  /**
   * Constructs a new TextTable from the given headers and data.
   *
   * @param headers The headers of the table.
   * @param data    The data of the table.
   */
  private TextTable(String[] headers, String[][] data) {
   ...
   * @return A new TextTable instance that can be printed using the {@link TextTable#toString()}.
   */
  @SuppressWarnings("WeakerAccess")
  public static TextTable fromData(String[] headers, String[][] data) {
    ...
    // Create an TextTable instance.
    return new TextTable(headers, data);
  }
   ...
   * @return This TextTable instance.
   */
  public TextTable withTableFormat(AbstractTableFormat tableFormat) {
   ...
   * @return This TextTable instance.
   */
  public TextTable withNullValue(String nullValue) {
    this.nullValue = nullValue;
    return this;
  }

  public TextTable alignColumn(int column, Align align) {
