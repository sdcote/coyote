...
/**
 * This sets the value of a field  to a particular value based on some condition.
 * 
 ...
 * <li>Condition - The boolean expression which must evaluate to true foe the value to be set. (defaults to "true")</li>
 * <li>Value - The value to set in the named field if the condition evaluates to true or is omitted. (Required)</li>
 * <li>Default - The value to set in the named field if the {@code Condition} evaluates to false. (optional, requires {@code Condition}</li>
 * </ul>
 * 
 */
