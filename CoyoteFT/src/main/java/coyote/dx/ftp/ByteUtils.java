...
public class ByteUtils {
  ...
  static private boolean glob0( final byte[] pattern, final int pattern_index, final byte[] name, final int name_index ) {
  ...
  static private boolean glob( final byte[] pattern, final int pattern_index, final byte[] name, final int name_index ) {
  ...
  static Socket createSocket( final String host, final int port, final int timeout ) throws FileTransferException {
    Socket socket = null;
    if ( timeout == 0 ) {
      try {
