...
public class TimeTest {
  ...
  public void testFormatTimeWithDecimals() {
    NMEATime t = new NMEATime( 1, 2, 3.456 );
  ...
  public void testFormatTimeWithOneDecimal() {
    NMEATime t = new NMEATime( 1, 2, 3.4 );
  ...
  public void testParseTimeWithDecimals() {
    NMEATime t = new NMEATime( "010203.456" );
  ...
  public void testParseTimeWithOneDecimal() {
    NMEATime t = new NMEATime( "010203.4" );
    assertEquals( 1, t.getHour() );
    assertEquals( 2, t.getMinutes() );
  ...
  public void testParseTimeWithoutDecimals() {
    NMEATime t = new NMEATime( "010203" );
    assertEquals( 1, t.getHour() );
    assertEquals( 2, t.getMinutes() );
  ...
  public void testEquals() {
    ...
    NMEATime a = new NMEATime( 1, 2, 3.456 );
    NMEATime b = new NMEATime( 1, 2, 3.456 );
    NMEATime c = new NMEATime( 2, 3, 4.567 );
